...
Try {
	...
	[SemVer]$InputPowerShellGetVersionNumber = [SemVer]::Parse((($InputPowerShellGetVersionRaw -imatch $SemVerRangeRegEx) ? $InputPowerShellGetVersionRaw.Replace($Matches[0]) : $InputPowerShellGetVersionRaw))
}
Catch {
...
Try {
	...
	[SemVer]$InputToolkitVersionNumber = [SemVer]::Parse((($InputToolkitVersionRaw -imatch $SemVerRangeRegEx) ? $InputToolkitVersionRaw.Replace($Matches[0]) : $InputToolkitVersionRaw))
}
Catch {
